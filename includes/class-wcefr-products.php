...
class WCEFR_Products {
	...
	public function products_settings() {
		...
		if ( isset( $_POST['wcefr-products-settings-nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['wcefr-products-settings-nonce'] ) ), 'wcefr-products-settings' ) ) {
