			...
			<td>
				<select class="wcefr-orders-statuses wcefr-select" name="wcefr-orders-statuses[]" multiple data-placeholder="<?php esc_html_e( 'All orders types', 'wc-exporter-for-reviso' ); ?>">
					...
					foreach ( $statuses as $key => $value ) {
						...
						echo ( in_array( $key, $saved_statuses, true ) ) ? ' selected="selected">' : '>';
...
<form name="wcefr-orders-settings" class="wcefr-form"  method="post" action="">
	...
	if ( isset( $_POST['wcefr-orders-settings-sent'], $_POST['wcefr-orders-settings-nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['wcefr-orders-settings-nonce'] ) ), 'wcefr-orders-settings' ) ) {
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="checkbox" name="wcefr-export-orders" value="1"<?php echo 1 === intval( $wcefr_export_orders ) ? ' checked="checked"' : ''; ?>>
		...
		<tr class="wcefr-create-invoices-field">
			...
			<td>
				<input type="checkbox" name="wcefr-create-invoices" value="1"<?php echo 1 === intval( $wcefr_create_invoices ) ? ' checked="checked"' : ''; ?>>
		...
		<tr class="wcefr-invoices-field wcefr-issue-invoices-field" style="display: none;">
			...
			<td>
				<input type="checkbox" class="wcefr-issue-invoices" name="wcefr-issue-invoices" value="1"<?php echo 1 === intval( $wcefr_issue_invoices ) ? ' checked="checked"' : ''; ?>>
		...
		<tr class="wcefr-invoices-field wcefr-send-invoices-field" style="display: none;">
			...
			<td>
				<input type="checkbox" class="wcefr-send-invoices" name="wcefr-send-invoices" value="1"<?php echo 1 === intval( $wcefr_send_invoices ) ? ' checked="checked"' : ''; ?>>
		...
		<tr class="wcefr-invoices-field wcefr-book-invoices-field" style="display: none;">
			...
			<td>
				<input type="checkbox" name="wcefr-book-invoices" value="1"<?php echo 1 === intval( $wcefr_book_invoices ) ? ' checked="checked"' : ''; ?>>
